...
export const workerKeys = {
    ...
    processes: (workerId: string) =>
        [...workerKeys.all, "processes", workerId] as const,
    processWorkers: (processId: string) =>
...
export const useApplyToProcess = () => {
    ...
    return useMutation({
        mutationFn: (data: ApplyToProcessDto) =>
            workersService.applyToProcess(data),
        onSuccess: (_, variables) => {
            queryClient.invalidateQueries({
                queryKey: workerKeys.processes(variables.workerId),
            });
            queryClient.invalidateQueries({
                queryKey: workerKeys.processWorkers(variables.processId),
            });
        },
    });
};
...
export const useUploadCV = () => {
    ...
    return useMutation({
        ...
        onSuccess: (_, variables) => {
            queryClient.invalidateQueries({
                queryKey: workerKeys.detail(variables.workerId),
            });
        },
    });
};
