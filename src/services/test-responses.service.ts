...
class TestResponsesService {
    ...
    async startTest(data: StartTestDto): Promise<TestResponse> {
        const response = await apiService.post<TestResponse>(
            `${this.basePath}/start`,
            data
        );
        return response.data;
    ...
    async submitTest(
        ...
        const response = await apiService.post<TestResponse>(
            `${this.basePath}/${responseId}/submit`,
            data
        );
        return response.data;
    }
    ...
    async autoEvaluate(responseId: string): Promise<TestResponse> {
        const response = await apiService.post<TestResponse>(
            `${this.basePath}/${responseId}/auto-evaluate`
        );
        return response.data;
    }
    ...
    async evaluateAnswer(
        ...
        const response = await apiService.patch<TestAnswer>(
            `${this.basePath}/answer/${answerId}/evaluate`,
            data
        );
        return response.data;
    }
    ...
    async recalculateScore(responseId: string): Promise<TestResponse> {
        const response = await apiService.post<TestResponse>(
            `${this.basePath}/${responseId}/recalculate`
        );
        return response.data;
    }
    ...
    async findByWorkerProcess(
        ...
        const response = await apiService.get<TestResponse[]>(
            `${this.basePath}/worker-process/${workerProcessId}`
        );
        return response.data;
    }
    ...
    async getAllStats(): Promise<TestResponseStats> {
        const response = await apiService.get<TestResponseStats>(
            `${this.basePath}/stats`
        );
        return response.data;
    }
