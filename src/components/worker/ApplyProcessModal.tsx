                        ...
                        <div className="space-y-3">
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Tu postulación será registrada de
                                        inmediato
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Nuestros evaluadores revisarán tu perfil
                                        y resultados
                                    </p>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-amber-700 mt-1">
                                        ...
                                        {process.tests.length === 1
                                            ? "test"
                                            : "tests"}{" "}
                                        que deberás completar. Recibirás una
                                        notificación cuando estén disponibles.
                                    </p>
                                </div>
                            </div>
                        </div>
