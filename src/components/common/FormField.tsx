...
export const InputField = ({ label, error, required, helperText, className = '', ...props }: InputFieldProps) => {
  return (
...
export const TextareaField = ({ label, error, required, helperText, className = '', rows = 4, ...props }: TextareaFieldProps) => {
  return (
    <div className="space-y-1">
      <label className="block text-sm font-medium text-gray-700">
        {label}
...
export const SelectField = ({ label, error, required, helperText, options, className = '', ...props }: SelectFieldProps) => {
  return (
    <div className="space-y-1">
      <label className="block text-sm font-medium text-gray-700">
        {label}
...
export const CheckboxField = ({ label, error, className = '', ...props }: BaseFieldProps & InputHTMLAttributes<HTMLInputElement>) => {
  return (
    <div className="space-y-1">
