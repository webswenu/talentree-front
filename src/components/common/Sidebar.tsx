...
import { getSectionsForRole, getLogoForRole, getTitleForRole } from '../../config/sidebar.config';
...
export const Sidebar = () => {
  ...
  const logo = getLogoForRole(user.role, user.company?.logoUrl);
    ...
    <div className="fixed inset-y-0 left-0 w-64 bg-white shadow-lg z-10">
      ...
      <div className="flex-col p-6 border-b flex justify-between items-center">
        <div className="flex flex-col items-center w-full">
          <img src={logo} alt="Logo" className="h-20 md:h-24 lg:h-32 w-auto mb-2" />
      ...
      {/* Navegación */}
      <nav className="mt-2 overflow-y-auto" style={{ height: 'calc(100vh - 220px)' }}>
