            ...
            <div className="flex justify-between items-center">
                <div className="flex-1">
                    ...
                    <p className="text-gray-500 text-sm mt-2">
                        Personaliza la configuración general del sistema y las preferencias de notificaciones. Modifica el nombre del sistema, información de contacto, zona horaria y controla cómo y cuándo recibes notificaciones sobre eventos importantes.
                    </p>
                </div>
