...
export const WorkerTestTakingPage = () => {
    ...
    }, [testResponseId, questions, answers, submitMutation, navigate]);
    ...
    useEffect(() => {
        ...
        const duration = testResponse.test.duration * 60;
