...
import { WorkerStatusLabels, WorkerStatusColors } from '../../types/worker.types';
...
export const WorkerApplicationsPage = () => {
  ...
  const stats = {
    ...
    inProcess: applications?.filter((app) => app.status === 'in_process').length || 0,
              ...
              applications.map((app) => (
                <tr key={app.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">{app.process.name}</div>
                    <div className="text-sm text-gray-500">{app.process.code}</div>
                  </td>
