...
export const CompanySettingsPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<'info' | 'notifications' | 'account'>('info');
  ...
  const [notificationsForm, setNotificationsForm] = useState({
    ...
    candidateUpdates: user?.notificationPreferences?.candidateUpdates ?? true,
    processReminders: user?.notificationPreferences?.processReminders ?? true,
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Administra la información de tu empresa y preferencias</p>
      </div>
      ...
      {activeTab === 'info' && (
        <form onSubmit={handleSaveCompanyInfo} className="bg-white rounded-lg shadow p-6 space-y-6">
          <div>
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Información de la Empresa</h2>
        ...
        <form onSubmit={handleSaveNotifications} className="bg-white rounded-lg shadow p-6 space-y-6">
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between py-3 border-b">
                <div>
                  <p className="font-medium text-gray-800">Nuevas Evaluaciones</p>
                  <p className="text-sm text-gray-600">Cuando se asignan nuevas evaluaciones</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    ...
                    onChange={(e) =>
                      setNotificationsForm({ ...notificationsForm, newEvaluations: e.target.checked })
                    }
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
              ...
              <div className="flex items-center justify-between py-3 border-b">
                <div>
                  <p className="font-medium text-gray-800">Actualizaciones de Candidatos</p>
                  <p className="text-sm text-gray-600">Cambios en el estado de candidatos</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    ...
                    onChange={(e) =>
                      setNotificationsForm({ ...notificationsForm, candidateUpdates: e.target.checked })
                    }
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
              ...
              <div className="flex items-center justify-between py-3">
                <div>
                  <p className="font-medium text-gray-800">Recordatorios de Procesos</p>
                  <p className="text-sm text-gray-600">Procesos próximos a vencer</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    ...
                    onChange={(e) =>
                      setNotificationsForm({ ...notificationsForm, processReminders: e.target.checked })
                    }
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
