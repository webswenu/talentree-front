...
export const RegisterWorkerPage = () => {
  ...
  const validateStep2 = (): boolean => {
    ...
    // Validación del dígito verificador deshabilitada para permitir cualquier RUT con formato correcto
  ...
  const handleNext = () => {
    ...
    if (currentStep === 1) {
      ...
      isValid = true; // Paso 3 todos los campos son opcionales
    }
  ...
  const handleRutChange = (value: string) => {
    // Solo permitir números, K y guión, sin formatear
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="text-center">
          <h2 className="text-4xl font-extrabold text-gray-900">Registro de Trabajador</h2>
        ...
        <div className="bg-white shadow-xl rounded-lg p-8">
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Datos de Acceso</h3>
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Información Personal</h3>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">Formato: 12345678-9 (sin puntos)</p>
              </div>
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              ...
              <p className="text-sm text-gray-600 mb-4">Estos campos son opcionales</p>
