            ...
            <nav className="bg-white shadow fixed w-full z-50 top-0">
                <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex gap-8 items-center">
                        ...
                        <a href="#plans" className="hover:text-teal-500">
                            Planes
                        </a>
            ...
            <section id="about" className="py-24 bg-gray-50">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
                    ...
                    <div className="md:w-1/2">
                        ...
                        <p className="text-gray-600 mb-6 leading-relaxed">
                            Nuestro equipo combina experiencia en recursos
                            humanos, análisis de datos y tecnología avanzada
                            para ofrecer procesos más eficientes, objetivos y
                            personalizados.
                        </p>
